...
//        shareView = UIView(frame: CGRect(x: frameWidth - 106, y: frameHeight / 8.6, width: 96, height: 48))
//        shareView.backgroundColor = .systemGray6
//        //shareView.roundCorners(corners: [.topLeft, .bottomLeft, .topRight, .bottomRight], radius: 16)
//        shareView.layer.cornerRadius = 16
//        shareView.transform = CGAffineTransform(scaleX: 0.5, y: 0.5)
//        shareView.alpha = 0
//        
...
//    @objc func hideView() {
//        UIView.animate(withDuration: 0.3) {
//            self.shareView.transform = CGAffineTransform(scaleX: 0.5, y: 0.5)
